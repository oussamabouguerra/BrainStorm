...
import map.GoogleMapsTestApp;

/**
 *
 * @author mouad
 */
public class GoogleMapForm extends Form{
     private static final String HTML_API_KEY = "AIzaSyAVN6_rqmZMK6mF4enV5P6rEJ7DCD3k5XU";
    private Form current;
    private Resources theme;
    MapContainer.MapObject sydney;
    public GoogleMapForm(Form previous) {
         setTitle("Google Map");
